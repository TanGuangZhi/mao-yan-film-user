<template>
  <div id="movie">
    ...
    <div class="subnav">
      <ul class="navbar">
        <li>
          <a :class="jump=='Film'?'active':''"  href="javascript:void(0);" @click="changeFilmType('Film')">影视({{filmLength}})</a>
        </li>
        <li>
          <a  :class="jump=='Cinema'?'active':''" href="javascript:void(0)" @click="changeFilmType('Cinema')">影院({{cinemaLength}})</a>
        </li>
      </ul>
    </div>
    <!--    电影显示区-->
